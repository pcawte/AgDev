...
FILE stdin[1]  = {{ FH_STDIN, 0, 0, FH_TEXT, 0 }};
FILE stdout[1] = {{ FH_STDOUT, 0, 0, FH_TEXT, 0 }};
FILE stderr[1] = {{ FH_STDERR, 0, 0, FH_TEXT, 0 }};
...
void _stdio_init( void ) {
	*stdin  = (FILE){ FH_STDIN, 0, 0, FH_TEXT, 0 };
	*stdout = (FILE){ FH_STDOUT, 0, 0, FH_TEXT, 0 };
	*stderr = (FILE){ FH_STDERR, 0, 0, FH_TEXT, 0 };
}